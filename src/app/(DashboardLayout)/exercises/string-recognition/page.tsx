...
function page() {
  return (
    <>
      <BreadcrumbComp title="String Recognition Exercises" items={BCrumb} emoji="🔤" />
              ...
              <div className="space-y-4">
                <div className="space-y-3 pb-4 border-b border-foreground/10">
                  <div className="flex items-start gap-3">
                    <Badge className="mt-1 bg-pink-600 hover:bg-pink-700 shrink-0">1</Badge>
                    <div>
                      <h4 className="font-semibold text-foreground">Complete the Argument</h4>
                ...
                <div className="space-y-3 pb-4 border-b border-foreground/10">
                  <div className="flex items-start gap-3">
                    <Badge className="mt-1 bg-pink-600 hover:bg-pink-700 shrink-0">2</Badge>
                    <div>
                      <h4 className="font-semibold text-foreground">String Pattern wwᵣw</h4>
                      <p className="text-muted-foreground text-sm mt-1">
                ...
                <div className="space-y-3 pb-4 border-b border-foreground/10">
                  <div className="flex items-start gap-3">
                    <Badge className="mt-1 bg-pink-600 hover:bg-pink-700 shrink-0">3</Badge>
                    <div>
                      <h4 className="font-semibold text-foreground">String Pattern www</h4>
                      <p className="text-muted-foreground text-sm mt-1">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <Badge className="mt-1 bg-pink-600 hover:bg-pink-700 shrink-0">4</Badge>
                    <div>
                      <h4 className="font-semibold text-foreground">Languages Outside NTIME(2ⁿ)</h4>
                      <p className="text-muted-foreground text-sm mt-1">
          ...
          <BlurFade inView delay={0.3}>
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground flex items-center gap-3">
                ...
                String Recognition Code (Python)
              </h3>
              <CodeBlock
                code={`def is_ww(s):
        if len(s) % 2 != 0:
